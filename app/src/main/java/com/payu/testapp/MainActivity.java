...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*Navigate to data/misc/wifi folder and you will find a file named wpa_supplicant.conf.
         Tap on the file to open it up and make sure you use ES File Explorer 's built-in text/HTML
         viewer for the task. In the file you should be able to see the network SSID and their
         passwords next to it.*/
